...
const int cooldown_chef = max_frame_rate * 3;
const int cooldown_killer = max_frame_rate * 2;
...
struct SphereData {
    ...
    std::string bulletPath = ""; // Opzionale, non tutte le sfere sparano proiettili
    ...
    // Senza Bullet
    SphereData(std::string name, sf::Color color, std::string imagePath, std::string weaponPath, std::string description, std::string attackDescription, int strength) {
        this->name = name;
        this->color = color;
...
SphereData boxer ("Boxer", sf::Color(255, 176, 0), "../Utilities/Images/Orange_Glove.png", "../Utilities/Weapons/Orange_Glove.png", "Lottatore coraggioso", "Guantoni", 50);
SphereData cowboy ("Cowboy", sf::Color(247, 255, 0), "../Utilities/Images/Yellow_Hat.png", "../Utilities/Weapons/Yellow_Revolver.png", "../Utilities/Weapons/Yellow_Bullet.png", "Cowboy giustiziere", "Revolver", 200);
SphereData chef ("Chef", sf::Color(0, 255, 27), "../Utilities/Images/Green_Pan.png", "../Utilities/Weapons/Green_Food.png", "Cuoco formidabile", "Padella", 100);
SphereData killer ("Killer", sf::Color(255, 0, 0), "../Utilities/Images/Red_Knife.png", "../Utilities/Weapons/Red_Knife.png", "Assassino spietato", "Coltello", 100);
SphereData magic ("Magic", sf::Color(67, 0, 255), "../Utilities/Images/Blue_Thunder.png", "../Utilities/Weapons/Blue_Thunder.png", "Mago del clima", "Fulmini", 100);
SphereData hunter ("Hunter", sf::Color(252, 0, 255), "../Utilities/Images/Purple_Trap.png", "../Utilities/Weapons/Purple_Trap.png", "Cacciatore spietato", "Trappole", 100);
